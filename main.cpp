...
AsyncResult<CompletionToken, variant<std::string, http::response<http::string_body>>>
httpRequest(
...
{
    using ret_t = variant<std::string, http::response<http::string_body>>;
